...
const HERBS = [
  {
    ...
    benefit: "Gently lifts scalp oil and impurities without breaking skin barrier. Rich in natural saponins.",
    icon: Flower2,
    color: "#D4AF37",
  },
  {
...
export default function IngredientsSection() {
  return (
    <section id="ingredients" className="py-20 bg-[#0A0A0A] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="text-xs sm:text-sm text-[#8A8F8C] max-w-xl mx-auto mt-2 leading-relaxed">
            Our signature formula contains 40+ handpicked wild botanicals cooked in virgin oils according to ancient Vedic texts.
          </p>
        </div>
        ...
        <div className="mt-10 p-6 rounded-2xl bg-gradient-to-r from-[#101512] via-[#0B3D2E]/50 to-[#101512] border border-[#D4AF37]/30 text-center">
          ...
          <p className="text-xs text-[#8A8F8C] max-w-4xl mx-auto leading-relaxed mt-1">
