...
export default function StickyBuyBar() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      // Show after scrolling past hero (approx 550px)
    ...
    <div className="fixed bottom-4 left-1/2 -translate-x-1/2 z-40 w-[92%] max-w-4xl bg-[#101512]/95 border border-[#D4AF37]/40 backdrop-blur-xl rounded-full p-2.5 sm:px-6 shadow-[0_10px_35px_rgba(0,0,0,0.9),0_0_20px_rgba(212,175,55,0.2)] transition-all duration-500 animate-in fade-in slide-in-from-bottom-5">
      <div className="flex items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          ...
          <div className="hidden sm:block">
            ...
            <p className="text-[11px] text-[#8A8F8C]">
              Buy Shikakai Powder → Get <span className="text-[#2FA36B] font-semibold">Free 20ml Oil Elixir</span>
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            href="/checkout"
            className="btn-gold-foil px-5 py-2.5 rounded-full text-xs uppercase tracking-widest flex items-center gap-2"
          >
